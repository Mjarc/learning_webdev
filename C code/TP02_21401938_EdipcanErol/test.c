...
int main()
{
    ...
    switch(case_no) {
        case 1:
            ;
            charPermu(string_to_copy);
            // TODO: You should print the strings as follows in your function.
        ...
        case 4:
            if (are_friends(values[1], values[2])) 
            {
        ...
        case 11:
            ...
            // TODO
            // You shoulf print in the function as follows:
